...
public:
	...
	static const std::string ActivityCheckUrl(const std::string& strUrl);

	static std::string UrlEncode(const std::string& str);
	static std::string UrlDecode(const std::string& str);

	static void DeletetFile(const std::string& stFilePath);
	static const bool CGetCurrentDirectory(std::string& strDirpath);
	static const bool ProcessRunStart(const std::wstring& strProcessPath, const std::wstring& strParm, std::wstring& strError);
};
